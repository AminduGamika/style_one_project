...
import 'package:style_one/features/shop/screens/store/store.dart';
...
class NavigationMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final darkMode = SOHelperFunctions.isDarkMode(context);
    ...
    return Scaffold(
      bottomNavigationBar: Obx(
        () => NavigationBar(
          ...
          backgroundColor: darkMode ? SOColors.black : Colors.white,
          indicatorColor: darkMode ? SOColors.primary.withOpacity(0.2) : SOColors.primary.withOpacity(0.2),
          destinations: const [
